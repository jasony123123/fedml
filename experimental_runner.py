...
federated_train_data = make_federated_data(emnist_train, emnist_train.client_ids[:500])
federated_test_data = make_federated_data(emnist_test, emnist_test.client_ids[:500])
...
for round_num in range(1, NUM_ROUNDS+1):
  state, metrics = iterative_process.next(state, sample(federated_train_data, 25))
  test_metrics = evaluation(state.model, federated_test_data)
  print('round {:2d}\ntrain_metrics={}\ntrain_metrics={}\n'.format(round_num, metrics, test_metrics))
# # #@test {"skip": true}
